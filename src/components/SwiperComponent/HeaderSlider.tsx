...
const HeaderSlider = () => {
  return (
    <div className="relative min-h-[30vh] lg:h-[70vh]">
        ...
        <SwiperSlide>
          <div className="relative min-h-[30vh] lg:h-[70vh] w-full">
            ...
            <div className="absolute inset-0 flex flex-col pl-10  md:pl-28 text-white justify-center ">
              ...
              <Link href="/shop" className="mt-4 w-fit bg-black text-white px-6 py-2 hover:bg-gray-800 transition">
                Shop Now
              </Link>
            </div>
          </div>
      ...
      <button className="swiper-prev w-8 h-8 absolute left-4 top-1/2 -translate-y-1/2 z-20 bg-black/70 rounded-full flex items-center justify-center text-white text-xl">
        ‹{' '}
      </button>
      <button className="swiper-next w-8 h-8 absolute right-4 top-1/2 -translate-y-1/2 z-20 bg-black/70 rounded-full flex items-center justify-center text-white text-xl">
        {' '}
        ›{' '}
      </button>
    </div>
