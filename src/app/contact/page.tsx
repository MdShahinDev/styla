    ...
    <div className="my-14">
           <form className="flex flex-col items-center text-sm text-slate-800">
            ...
            <p className="max-md:text-sm text-gray-500 pb-10 text-center">
                Or just reach out manually to us at <a href="mailto:hello.shahinofficial@gmail.com" className="text-indigo-600 hover:underline">hello.shahinofficial@gmail.com</a>
            </p>
            ...
            <div className="max-w-96 w-full px-4">
                ...
                <button type="submit" className="flex items-center justify-center gap-1 mt-5 bg-black hover:bg-black/90 text-white py-2.5 w-full rounded-full transition">
                    Submit Form
